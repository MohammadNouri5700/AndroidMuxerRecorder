        ...
        while (mIsCapturing) {
            ...
            if (encoderStatus == MediaCodec.INFO_TRY_AGAIN_LATER) {
                ...
                if (mBufferInfo.size != 0) {
                    ...
                    mMediaCodec.setParameters(syncParam);
                    if (this instanceof MediaAudioEncoder) {
                        mBufferInfo.presentationTimeUs = getPTSUs();
                        muxer.writeSampleDataAudio(mMediaCodec, mTrackIndex, encoderStatus, encodedData, mBufferInfo);
                        prevOutputPTSUs = mBufferInfo.presentationTimeUs;
                    } else {
                        mBufferInfo.presentationTimeUs = getPTSUs();
                        muxer.writeSampleData(mMediaCodec, mTrackIndex, encoderStatus, encodedData, mBufferInfo);
                        prevOutputPTSUs = mBufferInfo.presentationTimeUs;
                    }
                }
